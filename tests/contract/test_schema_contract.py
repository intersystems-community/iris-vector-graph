...
class TestSchemaContract:
    ...
    def test_identity_syntax_is_iris_native(self):
        ...
        IRIS syntax: BIGINT IDENTITY PRIMARY KEY
        ...
        for pattern in invalid_patterns:
            ...
            assert len(matches) == 0, (
                ...
                f"Use IRIS-native syntax: BIGINT IDENTITY PRIMARY KEY"
            )

        # Verify IRIS-native IDENTITY syntax is used
        iris_identity_pattern = r'BIGINT\s+IDENTITY\s+PRIMARY\s+KEY'
        ...
        assert len(matches) >= 1, (
            ...
            "Expected: BIGINT IDENTITY PRIMARY KEY"
        )
