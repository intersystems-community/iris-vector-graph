...
class TestCreateProteinMutation:
    ...
    def cleanup_test_data(self, iris_connection, engine):
    ...
    async def test_create_protein_basic(self, iris_connection, engine):
    ...
    async def test_create_protein_duplicate_id_error(self, iris_connection, engine):
    ...
    async def test_create_protein_minimal_required_fields(self, iris_connection, engine):
...
class TestUpdateProteinMutation:
    ...
    async def test_update_protein_fields(self, iris_connection, engine):
    ...
    async def test_update_protein_partial_fields(self, iris_connection, engine):
    ...
    async def test_update_protein_not_found(self, iris_connection, engine):
...
class TestDeleteProteinMutation:
    ...
    async def test_delete_protein_basic(self, iris_connection, engine):
    ...
    async def test_delete_protein_not_found(self, iris_connection, engine):
