...
class TestNestedFieldResolvers:
    ...
    async def test_protein_interacts_with_nested_query(self, iris_connection):
        ...
        try:
            ...
            pass
        try:
            cursor.execute("INSERT INTO Graph_KG.rdf_labels (s, label) VALUES (?, ?)", ("PROTEIN:TP53", "Protein"))
        except:
            pass
        try:
        ...
        # Protein 2: MDM2
        try:
            cursor.execute("INSERT INTO Graph_KG.nodes (node_id) VALUES (?)", ("PROTEIN:MDM2",))
        except:
            pass
        try:
            cursor.execute("INSERT INTO Graph_KG.rdf_labels (s, label) VALUES (?, ?)", ("PROTEIN:MDM2", "Protein"))
        except:
            pass
        try:
            cursor.execute("INSERT INTO Graph_KG.rdf_props (s, key, val) VALUES (?, ?, ?)",
    ...
    async def test_gene_encodes_nested_query(self, iris_connection):
        ...
        # Gene: TP53
        try:
            cursor.execute("INSERT INTO Graph_KG.nodes (node_id) VALUES (?)", ("GENE:TP53",))
        except:
            pass
        try:
            cursor.execute("INSERT INTO Graph_KG.rdf_labels (s, label) VALUES (?, ?)", ("GENE:TP53", "Gene"))
        except:
            pass
        try:
            cursor.execute("INSERT INTO Graph_KG.rdf_props (s, key, val) VALUES (?, ?, ?)",
...
def nested_query_test_cleanup(iris_connection):
    ...
    for node_id in test_nodes:
        try:
            cursor.execute("DELETE FROM Graph_KG.rdf_edges WHERE s = ? OR o_id = ?", (node_id, node_id))
